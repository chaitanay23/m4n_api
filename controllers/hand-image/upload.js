        ...
        if (result == false) {
            ...
            if (jwt_result && jwt_result != undefined) {
                new formidable.IncomingForm().parse(req, (err, fields, files) => {
                    ...
                    //Uploading Images
                    left_hand = handUpload(files.left_hand, type = 'left_hand', user_id);
                    left_thumb = handUpload(files.left_thumb, type = 'left_thumb', user_id);
                    right_hand = handUpload(files.right_hand, type = 'right_hand', user_id);
                    right_thumb = handUpload(files.right_thumb, type = 'right_thumb', user_id);


                    if (left_hand == undefined && left_thumb == undefined && right_hand == undefined && right_thumb == undefined) {
